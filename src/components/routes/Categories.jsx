              ...
              <div className="category-content uk-container">
                ...
                <div className="categories-buttons">
                    <div className="uk-inline-clip uk-transition-toggle" tabindex="0">
                        <img src="https://res.cloudinary.com/dqdpblijd/image/upload/v1539533430/ruta-s/button6_gray.png" onClick={()=>this.redirect('Tradicional')} name="tradicional" value="tradicional"/>
                    ...
                    <div className="uk-inline-clip uk-transition-toggle" tabindex="0">
                        <img src="https://res.cloudinary.com/dqdpblijd/image/upload/v1539533429/ruta-s/button5_gray.png" onClick={()=>this.redirect('Chef')} name="chef" value="chef"/>  
                    ...
                    <div className="uk-inline-clip uk-transition-toggle" tabindex="0">
                        <img src="https://res.cloudinary.com/dqdpblijd/image/upload/v1539533429/ruta-s/button4_gray.png" onClick={()=>this.redirect('Economico')} name="economico" value="economico"/>  
                    ...
                    <div className="uk-inline-clip uk-transition-toggle" tabindex="0">
                        <img src="https://res.cloudinary.com/dqdpblijd/image/upload/v1539533427/ruta-s/button3_gray.png" onClick={()=>this.redirect('Dulce')} name="dulce" value="dulce"/>  
                    ...
                    <div className="uk-inline-clip uk-transition-toggle" tabindex="0">
                        <img src="https://res.cloudinary.com/dqdpblijd/image/upload/v1539533427/ruta-s/button2_gray.png" onClick={()=>this.redirect('Bebidas')} name="bebidas" value="bebidas"/> 
                    ...
                    <div className="uk-inline-clip uk-transition-toggle" tabindex="0">
                        <img src="https://res.cloudinary.com/dqdpblijd/image/upload/v1539533427/ruta-s/button1_gray.png" onClick={()=>this.redirect('Callejera')} name="callejera" value="callejera" /> 
